...
object TestUtil {
    ...
    val CURRENCY_RATE_1 = CurrencyRate("USD", 1.1234f.toBigDecimal())
    val CURRENCY_RATE_2 = CurrencyRate("GBP", 0.7812f.toBigDecimal())
    ...
    val CURRENCY_1_X0 = Currency(CURRENCY_RATE_1.code, "0.00", 1)
    val CURRENCY_2_X0 = Currency(CURRENCY_RATE_2.code, "0.00", 1)
